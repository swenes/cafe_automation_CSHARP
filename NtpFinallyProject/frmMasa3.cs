...
namespace NtpFinallyProject
{
    public partial class frmMasa3 : Form
    {
        ...
        private void btnAnasayfa_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMasa1.anasayfa.hesabiGosterM3(toplamTutarM3);
            ...
            {
                frmMasa1.anasayfa.lblTutarM3.Visible = false;
        ...
        private void btnNakitOde_Click(object sender, EventArgs e)
        {
            ...
            {
                nakitOdemeToplamı = toplamTutarM3;
        ...
        private void btnKartOde_Click(object sender, EventArgs e)
        {
            ...
            {
                kartOdemeToplamı = toplamTutarM3;
        ...
        private void btn1KgProf_Click(object sender, EventArgs e)
        {
            ...
            toplamTutarM3 += (comboBox1.SelectedIndex + 1) * db.Profiterol1kg();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox3.SelectedIndex + 1) * db.Profiterol750gr();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox2.SelectedIndex + 1) * db.Profiterol500gr();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox4.SelectedIndex + 1) * db.ProfiterolPorsiyon();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox5.SelectedIndex + 1) * db.Ekler1KG();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox6.SelectedIndex + 1) * db.Ekler750gr();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox8.SelectedIndex + 1) * db.EklerPorsiyon();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox7.SelectedIndex + 1) * db.Ekler500gr();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox9.SelectedIndex + 1) * db.TekKisilikPasta();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox32.SelectedIndex + 1) * db.Trilice();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox29.SelectedIndex + 1) * db.Tiramisu();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox28.SelectedIndex + 1) * db.Magnolia();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox27.SelectedIndex + 1) * db.Donut();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox26.SelectedIndex + 1) * db.Makaron();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox25.SelectedIndex + 1) * db.SanSenbastian();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox10.SelectedIndex + 1) * db.Pasta46();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox11.SelectedIndex + 1) * db.Pasta68();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox12.SelectedIndex + 1) * db.Dondurma1Top();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox31.SelectedIndex + 1) * db.Dondurma1Kg();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox30.SelectedIndex + 1) * db.Dondurma500Gr();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox24.SelectedIndex + 1) * db.TurkKahvesi();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox23.SelectedIndex + 1) * db.KahveCesitleri();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox22.SelectedIndex + 1) * db.Su();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox18.SelectedIndex + 1) * db.Cay();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox17.SelectedIndex + 1) * db.FincanCay();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox16.SelectedIndex + 1) * db.MadenSuyu();
            label2.Text = toplamTutarM3.ToString();
        ...
        {
            toplamTutarM3 += (comboBox21.SelectedIndex + 1) * db.KutuSiseVeMesrubatCesitleri();
            label2.Text = toplamTutarM3.ToString();
