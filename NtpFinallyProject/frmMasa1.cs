...
namespace NtpFinallyProject
{
    public partial class frmMasa1 : Form
    {
        ...
        {
            if (anasayfa.masaDoluMuM1())
            {
                anasayfa.hesabiGosterM1(toplamTutarM1);
                anasayfa.btnMasa1.BackColor = Color.Maroon;
               

            }
            else
            {
                frmMasa1.anasayfa.lblTutarM1.Visible = false;
                anasayfa.btnMasa1.BackColor = Color.Green;
            }

            if (anasayfa.masaDoluMuM2())
            {
               
                anasayfa.btnMasa2.BackColor = Color.Maroon;
            ...
            {
                anasayfa.btnMasa2.BackColor = Color.Green;
            }
        ...
        private void btnNakitOde_Click(object sender, EventArgs e)
        {
            ...
            {
                nakitOdemeToplamı = toplamTutarM1;
                anasayfa.gunSonu.Add(nakitOdemeToplamı);
                anasayfa.gunSonuNakit.Add(nakitOdemeToplamı);

                DialogResult secenek4 = MessageBox.Show("NAKİT ÖDEME SEÇENEĞİNİ ONAYLIYOR MUSUNUZ ?", "Bilgilendirme Penceresi", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);

                if (secenek4 == DialogResult.Yes)
                {
        ...
        private void btnKartOde_Click(object sender, EventArgs e)
        {
            ...
            {
                kartOdemeToplamı = toplamTutarM1;
                anasayfa.gunSonu.Add(kartOdemeToplamı);
                anasayfa.gunSonuKredi.Add(kartOdemeToplamı);
                DialogResult secenek3 = MessageBox.Show("KREDİ KARTI İLE ÖDEME SEÇENEĞİNİ ONAYLIYOR MUSUNUZ ?", "Bilgilendirme Penceresi", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        ...
        private void btnMasayiBosalt_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DialogResult secenek6 = MessageBox.Show("SİPARİŞİ İPTAL ETMEK İSTİYOR MUSUNUZ ?", "Bilgilendirme Penceresi", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);

                if (secenek6 == DialogResult.Yes)
                {
        ...
        private void btnProf1Kg(object sender, EventArgs e)
        {
            //tutar

            toplamTutarM1 += (comboBox1.SelectedIndex + 1) * db.Profiterol1kg();
            label2.Text = toplamTutarM1.ToString()+ " ₺";
        ...
        {
            toplamTutarM1 += (comboBox3.SelectedIndex + 1) * db.Profiterol750gr();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox2.SelectedIndex + 1) * db.Profiterol500gr();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox4.SelectedIndex + 1) * db.ProfiterolPorsiyon();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox5.SelectedIndex + 1) * db.Ekler1KG();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox6.SelectedIndex + 1) * db.Ekler750gr();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox8.SelectedIndex + 1) * db.EklerPorsiyon();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox7.SelectedIndex + 1) * db.Ekler500gr();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox9.SelectedIndex + 1) * db.TekKisilikPasta();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox32.SelectedIndex + 1) * db.Trilice();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox29.SelectedIndex + 1) * db.Tiramisu();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox28.SelectedIndex + 1) * db.Magnolia();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox27.SelectedIndex + 1) * db.Donut();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox26.SelectedIndex + 1) * db.Makaron();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox25.SelectedIndex + 1) * db.SanSenbastian();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox10.SelectedIndex + 1) * db.Pasta46();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox11.SelectedIndex + 1) * db.Pasta68();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox12.SelectedIndex + 1) * db.Dondurma1Top();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox31.SelectedIndex + 1) * db.Dondurma1Kg();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox30.SelectedIndex + 1) * db.Dondurma500Gr();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox24.SelectedIndex + 1) * db.TurkKahvesi();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox23.SelectedIndex + 1) * db.KahveCesitleri();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox22.SelectedIndex + 1) * db.Su();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox18.SelectedIndex + 1) * db.Cay();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox17.SelectedIndex + 1) * db.FincanCay();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox16.SelectedIndex + 1) * db.MadenSuyu();
            label2.Text = toplamTutarM1.ToString();
        ...
        {
            toplamTutarM1 += (comboBox21.SelectedIndex + 1) * db.KutuSiseVeMesrubatCesitleri();
            label2.Text = toplamTutarM1.ToString();
